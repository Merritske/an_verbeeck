...
function hideNav(e){
    for(let i=0; i<aNav.length; i++){
        if(aNav[i].innerHTML === e.currentTarget.lastChild.innerHTML){
         aNav[i].style.visibility = "hidden"
    ...
    return (
        <div className='navbar'>
            <ul>
                ...
                <li className='navitem' onMouseEnter={showNav} onMouseLeave={hideNav} >
                <svg xmlns="http://www.w3.org/2000/svg" className="ionicon" viewBox="0 0 512 512"><title>Construct</title>
